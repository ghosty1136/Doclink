                  ...
                  onTap: () async {
                    try {
                      ...
                      if (googleUser != null) {
                        ...
                        // Create the AuthCredential for Firebase Authentication
                        ...
                        if (user != null) {
                          ...
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                              builder: (context) => Home(), // Home screen after login
                            ),
                          );
                        } else {
                          _showMsg('Login Failed: User not found');
                        }
                      } else {
                        _showMsg('Login Failed: Google Sign-In was canceled');
                      }
                    } catch (e) {
                      _showMsg('Sign-In Failed: $e');
